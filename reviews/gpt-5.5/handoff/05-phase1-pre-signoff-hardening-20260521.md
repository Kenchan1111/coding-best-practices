...
scope: scripts/skill-lib.ts, scripts/sync-catalog.ts, scripts/validate.ts, skill/tests, skill/README.md, ARCHITECTURE.md, TODOS.md
synopsis: "Durcissement pre-signoff limite a Phase 1 : suppression du hardcoding du catalogue, parseur frontmatter YAML partage pour tests/E2E mock, tests de derive supplementaires, et rappel documentaire explicite sur la limite du mock P7."
---
