...
scope: TODOS.md, scripts/knowledge_os.py, scripts/local_git_guard.py, scripts/skill-lib.ts, scripts/sync-catalog.ts, skill/bin/README.md, skill/tests
synopsis: "Lot de resynchronisation locale apres la review Kimi swarm : integration de la note de review, suppression du reliquat hardcode dans sync-catalog, discovery Kimi par defaut, correctif Merkle + test, documentation du stub skill/bin, et remise au vert de local_git manifests."
---
